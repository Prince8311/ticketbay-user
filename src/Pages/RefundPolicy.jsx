            ...
            <RefundPolicyPageWrapper>
                <div className="page_content">
                    ...
                    <div className="page_items">
                        <li>
                            <b>
                                This cancellation and refund policy outlines how you can cancel or seek a refund for a ticket or service that you have purchased through the Platform. Under this policy:
                            </b>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p>
                                <i className="fa-solid fa-circle-dot"></i>
                                <span>Phone  :</span>
                                <a href="tel:+91-9449618559">+91-9449618559</a>
                            </p>
                            <p>
                                <i className="fa-solid fa-circle-dot"></i>
                                <span>
                                    <b>Address :</b>
                                    THE MERIDIAN Luxury Hotel, District Stadium Main Road(Kurvangi main road), Dhantaramakki, Chikkamagaluru – 577101, Karnataka, India
                                </span>
                            </p>
                        </li>
                    </div>
